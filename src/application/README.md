...
The application layer sits between the domain layer and the presentation (UI) layer. It orchestrates
the flow of data to and from the domain layer and implements use cases that depend on domain
objects.

## Structure

- **Stores**: Contains Zustand stores that provide state management and connect the UI to domain
  services
